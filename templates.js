...
function appendExerciseToEditor(ex, exIdx) {
    ...
    div.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            <div style="font-weight: bold; font-size: 14px;">${ex.name}</div>
            <div style="color: #ff6b81; cursor: pointer; padding: 4px;" onclick="this.parentElement.parentElement.remove()">
                <i class="fa-solid fa-times"></i>
            </div>
        </div>
        <div style="display: flex; gap: 8px;">
            <div style="flex: 1; display: ${isWeight ? 'block' : 'none'};">
