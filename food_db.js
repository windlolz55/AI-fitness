...
// 擴充版：包含台灣常見食物、小吃、與超商連鎖食品
const foodDatabase = {
    categories: [
        { id: 'starch',    name: '🍚 澱粉主食', icon: 'fluent-emoji-flat:cooked-rice',          color: '#F59E0B' },
        { id: 'meat',      name: '🥩 肉類',     icon: 'fluent-emoji-flat:cut-of-meat',          color: '#EF4444' },
        { id: 'seafood',   name: '🐟 海鮮',     icon: 'fluent-emoji-flat:fish',                 color: '#38BDF8' },
        { id: 'egg',       name: '🥚 蛋豆類',   icon: 'fluent-emoji-flat:egg',                  color: '#FBBF24' },
        { id: 'veg',       name: '🥬 蔬菜',     icon: 'fluent-emoji-flat:leafy-green',          color: '#1dd1a1' },
        ...
        { id: 'bento',     name: '🍱 便當套餐', icon: 'fluent-emoji-flat:bento-box',            color: '#F59E0B' },
        { id: 'store',     name: '🏪 超商食品', icon: 'fluent-emoji-flat:convenience-store',    color: '#818CF8' },
        { id: 'cheat',     name: '🍔 速食/舒壓',icon: 'fluent-emoji-flat:hamburger',            color: '#ff9ff3' },
    ...
    foods: [
        ...
        { id: 's6',  categoryId: 'starch', name: '馬鈴薯 (1顆/150g)',     cals: 120, macros: { p: 3,   c: 27, f: 0   }, icon: 'fluent-emoji-flat:potato' },
        { id: 's7',  categoryId: 'starch', name: '南瓜 (1碗/100g)',       cals: 70,  macros: { p: 2,   c: 17, f: 0   }, icon: 'fluent-emoji-flat:jack-o-lantern' },
        { id: 's8',  categoryId: 'starch', name: '芋頭 (100g)',           cals: 130, macros: { p: 2.5, c: 30, f: 0   }, icon: 'fluent-emoji-flat:roasted-sweet-potato' },
        { id: 's9',  categoryId: 'starch', name: '山藥 (100g)',           cals: 75,  macros: { p: 2,   c: 17, f: 0   }, icon: 'fluent-emoji-flat:potato' },
        { id: 's10', categoryId: 'starch', name: '玉米 (1根/150g)',       cals: 150, macros: { p: 5,   c: 33, f: 2   }, icon: 'fluent-emoji-flat:ear-of-corn' },
        { id: 's11', categoryId: 'starch', name: '燕麥片 (乾重50g)',      cals: 190, macros: { p: 7,   c: 33, f: 4   }, icon: 'fluent-emoji-flat:bowl-with-spoon' },
        ...
        { id: 'm14', categoryId: 'seafood', name: '鯛魚片 (100g)',        cals: 100, macros: { p: 20, c: 0, f: 2  }, icon: 'fluent-emoji-flat:fish' },
        { id: 'm15', categoryId: 'seafood', name: '秋刀魚 (1尾/150g)',    cals: 395, macros: { p: 28, c: 0, f: 32 }, icon: 'fluent-emoji-flat:fish' },
        { id: 'm16', categoryId: 'seafood', name: '虱目魚肚 (100g)',      cals: 250, macros: { p: 18, c: 0, f: 20 }, icon: 'fluent-emoji-flat:fish' },
        { id: 'm17', categoryId: 'seafood', name: '鱈魚 (煎/100g)',       cals: 200, macros: { p: 15, c: 5, f: 14 }, icon: 'fluent-emoji-flat:fish' },
        { id: 'm18', categoryId: 'seafood', name: '蝦仁/白蝦 (100g)',     cals: 90,  macros: { p: 20, c: 0, f: 1  }, icon: 'fluent-emoji-flat:shrimp' },
        ...
        // ================= 蛋豆類 =================
        { id: 'v1',  categoryId: 'egg', name: '水煮蛋 (1顆)',            cals: 75,  macros: { p: 6.5, c: 0.5, f: 5  }, icon: 'fluent-emoji-flat:egg' },
        { id: 'v2',  categoryId: 'egg', name: '荷包蛋/煎蛋 (1顆)',       cals: 110, macros: { p: 6.5, c: 0.5, f: 9  }, icon: 'fluent-emoji-flat:cooking' },
        { id: 'v3',  categoryId: 'egg', name: '炒蛋/滑蛋 (1份)',         cals: 150, macros: { p: 7,   c: 2,   f: 12 }, icon: 'fluent-emoji-flat:cooking' },
        { id: 'v25', categoryId: 'egg', name: '蔥花蛋 (1份)',            cals: 150, macros: { p: 10,  c: 2,   f: 11 }, icon: 'fluent-emoji-flat:cooking' },
        { id: 'v24', categoryId: 'egg', name: '茶葉蛋/滷蛋 (1顆)',       cals: 75,  macros: { p: 7,   c: 1,   f: 5  }, icon: 'fluent-emoji-flat:egg' },
        { id: 'v4',  categoryId: 'egg', name: '無糖豆漿 (400ml)',        cals: 140, macros: { p: 14,  c: 6,   f: 7  }, icon: 'fluent-emoji-flat:glass-of-milk' },
        { id: 'v5',  categoryId: 'egg', name: '傳統豆腐 (半塊/150g)',    cals: 130, macros: { p: 13,  c: 3,   f: 8  }, icon: 'fluent-emoji-flat:white-large-square' },
        { id: 'v6',  categoryId: 'egg', name: '嫩豆腐 (1盒/300g)',       cals: 150, macros: { p: 15,  c: 6,   f: 8  }, icon: 'fluent-emoji-flat:white-large-square' },
        { id: 'v7',  categoryId: 'egg', name: '百頁豆腐 (半條/100g)',    cals: 215, macros: { p: 13,  c: 5,   f: 17 }, icon: 'fluent-emoji-flat:white-large-square' },
        { id: 'v8',  categoryId: 'egg', name: '豆干 (3片/100g)',         cals: 160, macros: { p: 19,  c: 6,   f: 7  }, icon: 'fluent-emoji-flat:oden' },
        { id: 'v9',  categoryId: 'egg', name: '毛豆 (仁/100g)',          cals: 120, macros: { p: 11,  c: 10,  f: 5  }, icon: 'fluent-emoji-flat:pea-pod' },
        { id: 'v22', categoryId: 'egg', name: '綜合堅果 (1把/30g)',      cals: 180, macros: { p: 6,   c: 6,   f: 15 }, icon: 'fluent-emoji-flat:peanuts' },
        { id: 'v23', categoryId: 'egg', name: '花生醬 (1湯匙)',          cals: 100, macros: { p: 4,   c: 3,   f: 8  }, icon: 'fluent-emoji-flat:peanuts' },
        ...
        { id: 's16', categoryId: 'breakfast', name: '白饅頭 (1顆/80g)',      cals: 200, macros: { p: 6,  c: 42, f: 1  }, icon: 'fluent-emoji-flat:dumpling' },
        ...
        { id: 'st101',categoryId: 'store', name: '大成舒迷雞胸肉-椒鹽風味 (90g)',cals: 88,  macros: { p: 19,   c: 2,  f: 1.5 }, icon: 'fluent-emoji-flat:chicken' },
        ...
        { id: 'd6',  categoryId: 'cheat', name: '珍珠奶茶 (全糖/大杯)',  cals: 550, macros: { p: 5,  c: 95, f: 18 }, icon: 'fluent-emoji-flat:bubble-tea' },
        { id: 'd7',  categoryId: 'cheat', name: '珍珠奶茶 (微糖/大杯)',  cals: 450, macros: { p: 5,  c: 75, f: 15 }, icon: 'fluent-emoji-flat:bubble-tea' },
